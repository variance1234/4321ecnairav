...
def execute_one_single_gpu_run(time_stamp, temp_done_filename, result_dir, gpu_index, run_queue):
    try:
        ...
        while True:
            ...
            run_command = 'bash /working/3_0_run_single_server_inference_one_model.sh ' + env + ' "' + com + ' ' + temp_done_filename + '" ' + '/result/' + log_filename
                    ...
                    for model_name in model_names:
                        for training_type in training_type_list:
                            ...
                            for iTry in range(no_try):
                                ...
                                command = 'KERAS_BACKEND=%s python 3_inference_one_model.py %s %s %s %s %s %s %d %s %d %s %s %d' \
                                ...
                                # Log file
                                log_filename = '3_inference_one_model_%s_%s_%s_%s_%s_%s_%d_%s_%d_%d.log' \
